...
if __name__== "__main__":
    try: 
        coastal_counties_db_file = fd.askopenfilename(title="Choose coastal counties without GL database")
        tweet_db_files = fd.askopenfilenames(title="Choose ALL databases with coastal county tweets")
    ...
    for i, tweet_db_file in enumerate(tweet_db_files): 
        ...
        other_db_name = current_coastal_counties_db.attach(coastal_counties_db_file)
